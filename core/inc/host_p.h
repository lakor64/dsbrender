...
// Mouse service (brender fork)

void BR_RESIDENT_ENTRY HostMouseShow(void);
void BR_RESIDENT_ENTRY HostMouseHide(void);
void BR_RESIDENT_ENTRY HostMouseConstrain(br_window* window);
void BR_RESIDENT_ENTRY HostMouseUnconstrain(br_window* window);
...
// Pointer service (brender fork)

void BR_RESIDENT_ENTRY HostPointerLoadShapes(void);
void BR_RESIDENT_ENTRY HostPointerSetShape(br_uint_32 id);

// IDEA: See how to crate "resources" in br host
//void BR_RESIDENT_ENTRY HostPointerRegister(br_uint_32 id, char *name);


// Window service (brender fork)
